  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ring: "var(--color-ring)", /* deep laboratory blue */
        background: "var(--color-background)", /* warm off-white */
        foreground: "var(--color-foreground)", /* near-black */
        primary: {
          DEFAULT: "var(--color-primary)", /* deep laboratory blue */
        ...
        accent: {
          DEFAULT: "var(--color-accent)", /* vibrant red */
      ...
      animation: {
        ...
        "molecular-bond": "molecular-bond 800ms cubic-bezier(0.4, 0, 0.2, 1)",
        "element-hover": "element-hover 200ms ease-out",
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
